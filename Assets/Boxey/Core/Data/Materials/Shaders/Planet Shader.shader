...
Shader "Planet Shader"
{
	Properties
	{
		...
		_Steepness_Threshold("Steepness Threshold", Float) = 0.965
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float3 normalizeResult55 = normalize( ( WorldPosition - _Center_Instance ) );
				float dotResult56 = dot( normalizeResult55 , WorldNormal );
				float simplePerlin3D48 = snoise( IN.ase_texcoord8.xyz*_Steepness_Warping );
				...
				float simplePerlin3D28 = snoise( WorldPosition*_GrassWarping );
				simplePerlin3D28 = simplePerlin3D28*0.5 + 0.5;
				float4 lerpResult22 = lerp( _Grass , _Dark_Grass , simplePerlin3D28);
				

				float3 BaseColor = ( ( ( dotResult56 * 0.5 ) + 0.5 ) <= _Steepness_Threshold ? lerpResult46 : ( ( simplePerlin3D11 + distance( _Center_Instance , WorldPosition ) ) <= _Sand_Height ? lerpResult23 : lerpResult22 ) ).rgb;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float simplePerlin3D48 = snoise( IN.ase_texcoord5.xyz*_Steepness_Warping );
				simplePerlin3D48 = simplePerlin3D48*0.5 + 0.5;
				float4 lerpResult46 = lerp( _RockColor , _Dark_Rock , simplePerlin3D48);
				float simplePerlin3D11 = snoise( WorldPosition*0.125 );
				simplePerlin3D11 = simplePerlin3D11*0.5 + 0.5;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float dotResult56 = dot( normalizeResult55 , ase_worldNormal );
				float simplePerlin3D48 = snoise( IN.ase_texcoord3.xyz*_Steepness_Warping );
				simplePerlin3D48 = simplePerlin3D48*0.5 + 0.5;
				float4 lerpResult46 = lerp( _RockColor , _Dark_Rock , simplePerlin3D48);
				float simplePerlin3D11 = snoise( WorldPosition*0.125 );
				simplePerlin3D11 = simplePerlin3D11*0.5 + 0.5;
...
Node;AmplifyShaderEditor.ColorNode;19;-2055.793,1523.786;Inherit;False;Property;_Grass;Grass Color;1;0;Create;False;0;0;0;False;0;False;0.2431373,0.7921569,0.2745098,1;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.LerpOp;22;-1531.855,1393.128;Inherit;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.NoiseGeneratorNode;28;-2079.665,1869.734;Inherit;True;Simplex3D;True;False;2;0;FLOAT3;0,0,0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;25;-2058.789,1698.133;Inherit;False;Property;_Dark_Grass;Dark Grass Color;2;0;Create;False;0;0;0;False;0;False;0.07787468,0.4716981,0.0966282,1;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;14;-2336.97,1935.258;Inherit;False;Property;_GrassWarping;Grass Warping;0;0;Create;True;0;0;0;False;0;False;0.87;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;24;-2052.051,1126.003;Inherit;False;Property;_Dark_Sand;Dark Sand Color;6;0;Create;False;0;0;0;False;0;False;0.8117647,0.6784314,0.3098039,1;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;18;-2050.891,951.5571;Inherit;False;Property;_Sand;Sand Color;5;0;Create;False;0;0;0;False;0;False;1,0.8392157,0.3882353,1;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.LerpOp;23;-1594.393,946.1836;Inherit;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.NoiseGeneratorNode;27;-2063.817,1302.797;Inherit;True;Simplex3D;True;False;2;0;FLOAT3;0,0,0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;29;-2348.72,1458.199;Inherit;False;Property;_Sand_Warping;Sand Warping;3;0;Create;False;0;0;0;False;0;False;0.39;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.NoiseGeneratorNode;48;-1120.78,239.6648;Inherit;True;Simplex3D;True;False;2;0;FLOAT3;0,0,0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.PosVertexDataNode;50;-1368.49,254.0383;Inherit;False;0;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;44;-1240.769,59.75616;Inherit;False;Property;_Dark_Rock;Dark Rock Color;10;0;Create;False;0;0;0;False;0;False;0.3215686,0.227451,0.1490196,1;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;45;-1239.609,-114.6898;Inherit;False;Property;_RockColor;Rock Color;9;0;Create;True;0;0;0;False;0;False;0.3215686,0.2,0.09803922,1;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;-26.73115,-161.5493;Float;False;True;-1;2;UnityEditor.ShaderGraphLitGUI;0;12;Planet Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;21;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForward;False;False;0;;0;0;Standard;40;Workflow;1;0;Surface;0;0;  Refraction Model;0;0;  Blend;0;0;Two Sided;1;0;Fragment Normal Space,InvertActionOnDeselection;0;0;Forward Only;0;0;Transmission;0;0;  Transmission Shadow;0.5,False,;0;Translucency;0;0;  Translucency Strength;1,False,;0;  Normal Distortion;0.5,False,;0;  Scattering;2,False,;0;  Direct;0.9,False,;0;  Ambient;0.1,False,;0;  Shadow;0.5,False,;0;Cast Shadows;1;0;  Use Shadow Threshold;0;0;GPU Instancing;1;0;LOD CrossFade;1;0;Built-in Fog;1;0;_FinalColorxAlpha;0;0;Meta Pass;1;0;Override Baked GI;0;0;Extra Pre Pass;0;0;DOTS Instancing;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Write Depth;0;0;  Early Z;0;0;Vertex Position,InvertActionOnDeselection;0;638366482361752245;Debug Display;0;0;Clear Coat;0;0;0;10;False;True;True;True;True;True;True;True;True;True;False;;False;0
Node;AmplifyShaderEditor.RangedFloatNode;21;-355.2505,5.11676;Inherit;False;Constant;_Float0;Float 0;5;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;51;-843.5933,-199.2324;Inherit;False;Property;_Steepness_Threshold;Steepness Threshold;8;0;Create;False;0;0;0;False;0;False;0.965;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;46;-783.1108,-120.0633;Inherit;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;49;-1395.357,400.9672;Inherit;False;Property;_Steepness_Warping;Steepness Warping;7;0;Create;False;0;0;0;False;0;False;0.3;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleSubtractOpNode;53;-1794.021,-587.351;Inherit;False;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.NormalizeNode;55;-1645.385,-581.3854;Inherit;False;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.DotProductOpNode;56;-1460.385,-579.3854;Inherit;False;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;58;-1282.385,-511.3854;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0.5;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;59;-1106.385,-469.3854;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0.5;False;1;FLOAT;0
Node;AmplifyShaderEditor.Compare;43;-358.569,-158.8935;Inherit;False;5;4;0;FLOAT;0;False;1;FLOAT;0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.WorldNormalVector;63;-1718.001,-487.8798;Inherit;False;False;1;0;FLOAT3;0,0,1;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.WorldPosInputsNode;64;-3439.737,960.4695;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.Compare;16;-1187.793,720.3648;Inherit;True;5;4;0;FLOAT;0;False;1;FLOAT;0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.NoiseGeneratorNode;11;-1812.758,418.4121;Inherit;True;Simplex3D;True;False;2;0;FLOAT3;0,0,0;False;1;FLOAT;0.125;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;15;-1359.793,610.3646;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;17;-1486.792,803.3649;Inherit;False;Property;_Sand_Height;Sand Height;4;0;Create;False;0;0;0;False;0;False;0.1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.DistanceOpNode;67;-1740.324,690.1037;Inherit;False;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.Vector3Node;70;-3226.966,331.8866;Inherit;False;InstancedProperty;_Center;Center;11;0;Create;False;0;0;0;True;0;False;0,0,0;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.WorldPosInputsNode;62;-3295.756,-0.06974506;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
ASEEND*/
//CHKSM=A8D0DCF0D9CD18E75D903DFF3BBDCE35DB989BE7