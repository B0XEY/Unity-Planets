...
namespace Boxey.Planets.Core.Generation {
    ...
    public class Planet : MonoBehaviour {
        private const int MaxNewNodes = 4;
        ...
        [SerializeField] private bool smoothTerrain = false;
        ...
        //update Queue
        private HashSet<NodeUpdateCall> _nodesToUpdate;
        ...
        private void Start() {
            ...
            _nodesToUpdate = new HashSet<NodeUpdateCall>();
            _nodesToTerraform = new HashSet<NodeTerraformCall>();
            _modDataDictionary = new Dictionary<Vector3, float[]>();
            worldMat.SetVector(Center, StartingPosition);
            //View bounds
            _viewBounds = GeometryUtility.CalculateFrustumPlanes(playerCamera);
            
            //Create root octree node
            RootNode = new Node(this, null, divisions, StartingPosition, true);
            _nodesToUpdate.Add(new NodeUpdateCall(null, RootNode));
        ...
        private void HandelUpdateCalls() {
            ...
            var nodesToProcess = _nodesToUpdate.Take(maxNodeUpdatesPerFrame).ToList();
        ...
        private void UnSplitNode(Node currentNode){
            ...
            //Add to update Queue
            _nodesToUpdate.Add(new NodeUpdateCall(currentNode.ParentNode, currentNode));
        }
        #region Terraforming
        /// <summary>
